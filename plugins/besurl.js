...
window.g = {
  ...
  //=============视频===========
  //上游
  videoChanlinterface: api + '/video/way',
  //渠道
  videoMerchant: api + '/video/merchant',
  videoMerchantdelete: api + '/video/merchant/delete',
  //包管理
  videoProductPackage: api + '/video/productPackage',
//订单
  videoPayOrder: api + '/video/pay',
