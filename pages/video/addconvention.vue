      ...
      <el-row :gutter="10">
        ...
        <el-form ref="form" :model="form" label-width="150px">
          ...
          <el-form-item label="扣量基数">
              <el-input placeholder="请输入扣量基数" v-model="form.deductionBase">
                  <template slot="append">元</template>
              </el-input>
          </el-form-item>
          <el-form-item label="扣量比列">
              <el-input placeholder="请输入扣量比列" v-model="form.deductionRatio">
          ...
          <el-form-item label="结算比列">
            <el-input placeholder="结算比例" v-model="form.primaryChannel">
              <template slot="append">%</template>
            </el-input>
          </el-form-item>
...
export default {
    ...
    methods:{
      ...
      addconvention(){
        let api = window.g.videoProductPackage;
        let _this = this;
        ...
        _param.append("primaryChannel",_this.form.primaryChannel);
        Axios.post(api,_param).then((res)=>{
          ...
          if(res.data.code === 200){
            ...
            this.$router.push({path:'/video/convention'})
          }
        }).catch((err)=>{
          console.log(err)
        })
